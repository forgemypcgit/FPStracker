...
import { ArrowRight, Database, Gauge, ShieldCheck, Zap, ChevronRight, Monitor, MessageSquareText } from "lucide-react";
    ...
    <div className="page-wrap">
      ...
      <section className="relative pb-16 pt-6 sm:pt-14">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          ...
          <Link to="/companion" className="btn-secondary group">
            Companion
            <Monitor className="h-4 w-4 text-silver transition-transform duration-200 group-hover:translate-x-0.5" />
          </Link>
          <Link to="/feedback" className="btn-ghost group">
            Feedback
            <MessageSquareText className="h-4 w-4 text-silver transition-transform duration-200 group-hover:translate-x-0.5" />
          </Link>
        </div>
