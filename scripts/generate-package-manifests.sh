...
WINGET_DIR="${DIST_DIR}/package-managers/winget/manifests/p/PCBuilder/FPSTracker/${VERSION}"
...
cat > "${WINGET_DIR}/PCBuilder.FPSTracker.yaml" <<EOF
PackageIdentifier: PCBuilder.FPSTracker
...
cat > "${WINGET_DIR}/PCBuilder.FPSTracker.installer.yaml" <<EOF
PackageIdentifier: PCBuilder.FPSTracker
PackageVersion: ${VERSION}
...
cat > "${WINGET_DIR}/PCBuilder.FPSTracker.locale.en-US.yaml" <<EOF
PackageIdentifier: PCBuilder.FPSTracker
PackageVersion: ${VERSION}
PackageLocale: en-US
Publisher: PC Builder
...
ShortDescription: FPS benchmark capture and submission CLI for PC Builder
